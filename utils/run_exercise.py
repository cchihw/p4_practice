...
class ExerciseRunner:
    ...
    def do_net_cli(self):
        ...
        makeTerm(h1, title="h1 terminal",cmd="bash -c 'python3 worker.py --worker_id 1 --role 0 --bind_port 12345; exec bash'")
        makeTerm(h2, title="h2 terminal",cmd="bash -c 'python3 worker.py --worker_id 2 --role 1 --bind_port 12345; exec bash'")
        makeTerm(h3, title="h3 terminal",cmd="bash -c 'python3 worker.py --worker_id 3 --role 1 --bind_port 54321; exec bash'")
        makeTerm(h4, title="h4 terminal",cmd="bash -c 'python3 worker.py --worker_id 4 --role 1 --bind_port 44444; exec bash'")
